...
-(void)defaultStyle{
    ...
    [self setTitleColor:[UIColor blackColor] forState:UIControlEventTouchDown];
    self.backgroundColor = [UIColor whiteColor];
    self.layer.borderColor = [[UIColor colorWithRed:204/255.0 green:204/255.0 blue:204/255.0 alpha:1] CGColor];
    
    @weakify(self);
    [RACObserve(self, bounds) subscribeNext:^(NSValue *boundsObject) {
        if (boundsObject.CGRectValue.size.width == 0) {
            return ;
        }
        @strongify(self);
        [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:240/255.0 green:235/255.0 blue:235/255.0 alpha:1]] forState:UIControlEventTouchDown];
    }];
}
...
-(void)primaryStyle{
    ...
    [RACObserve(self, bounds) subscribeNext:^(NSValue *boundsObject) {
        ...
        @strongify(self);
        [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:51/255.0 green:119/255.0 blue:172/255.0 alpha:1]] forState:UIControlEventTouchDown];
    }];
}
...
-(void)successStyle{
    ...
    [RACObserve(self, bounds) subscribeNext:^(NSValue *boundsObject) {
        ...
        @strongify(self);
        [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:69/255.0 green:164/255.0 blue:84/255.0 alpha:1]] forState:UIControlEventTouchDown];
    }];
}
...
-(void)infoStyle{
    ...
    [RACObserve(self, bounds) subscribeNext:^(NSValue *boundsObject) {
        ...
        [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:57/255.0 green:180/255.0 blue:211/255.0 alpha:1]] forState:UIControlEventTouchDown];
    }];
}
...
-(void)warningStyle{
    ...
    [RACObserve(self, bounds) subscribeNext:^(NSValue *boundsObject) {
        ...
        @strongify(self);
        [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:237/255.0 green:155/255.0 blue:67/255.0 alpha:1]] forState:UIControlEventTouchDown];
    }];
}
...
-(void)dangerStyle{
    ...
    [RACObserve(self, bounds) subscribeNext:^(NSValue *boundsObject) {
        ...
        @strongify(self);
        [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:210/255.0 green:48/255.0 blue:51/255.0 alpha:1]] forState:UIControlEventTouchDown];
    }];
}
